<%@ Page Title="" Language="C#" MasterPageFile="~/crm.Master" AutoEventWireup="true" CodeBehind="_customerEmailOut.aspx.cs" Inherits="WorkbaseImm.customer._customerEmailOut" %>
                                        ...
                                        <div class="ibox-content mailbox-content">
                                            <div class="file-manager">
                                                ...
                                                <ul class="folder-list m-b-md" style="padding: 0">
                                                    <li><a href="#"><i class="fa fa-inbox "></i>Thư đến <span class="label label-warning float-right">16</span> </a></li>
                                                    <li><a href="#" class="active"><i class="fa fa-envelope-o"></i>Thư đã gửi</a></li>
                                                </ul>
